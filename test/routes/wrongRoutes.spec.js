...
describe("Checking for simple /routes-does-not-exits get routes", () => {
    it("should return error object with status 404", (done) => {
        chai_1.default.request(index_1.default)
            ...
            .end((err, res) => {
            (0, chai_1.expect)(res.status).to.equals(404);
            (0, chai_1.expect)(res.body.type).to.equals("General");
            (0, chai_1.expect)(res.body.message).to.equals('NOT_FOUND');
...
//# sourceMappingURL=wrongRoutes.spec.js.map